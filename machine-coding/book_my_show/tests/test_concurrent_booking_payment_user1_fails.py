...
class TestConcurrentBookingPaymentUser1FailsSessionClosedExplicitly:
    ...
    def test_concurrent_booking_payment_user1_fails(self) -> None:
        ...
        # Payment of User1 Fails and User1 explicitly closes session
        self.show1.cancel_seat_reservation(session_id=session_id)
