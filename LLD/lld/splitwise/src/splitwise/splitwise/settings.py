...
# Env Path
ENV_PATH = 'splitwise/.env.secret' 
ENV_CONFIGS = dotenv_values(dotenv_path=ENV_PATH)

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-mginymm-d(ih$yikcz_=%btw6c)m=af-zh#-jbanio+^3-y00@'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': ENV_CONFIGS.get('DB_USER_PASSWORD'),
